...
test_that("Test case 44",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/7),-(w2/5),-(w3/7)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/4),-(w2/2),-(w3/3)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/1),-(w2/5),-(w3/6)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/2),-(w2/4),-(w3/3)), byrow = TRUE, nrow = 1);
