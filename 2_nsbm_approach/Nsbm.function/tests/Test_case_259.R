...
return_to_scale = "VRS";
NIRS = 0;
Link_obj = 1; # No Link variable in the objective function
...
test_that("Test case 259",{


  error_ <- "Link variable in the objective function is only available for a non-oriented problem";
