...
test_that("Test case 210",{
  ...
  Const_1_i1 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/(1/300)),(0.5/(1/300)),rep(0,2)), byrow = TRUE, nrow = 1);
  Const_1_i2 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/(1/300)), (0.5/(1/300)),rep(0,2)), byrow = TRUE, nrow = 1);
  Const_1_i3 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/(1/300)), (0.5/(1/300)),rep(0,2)), byrow = TRUE, nrow = 1);
