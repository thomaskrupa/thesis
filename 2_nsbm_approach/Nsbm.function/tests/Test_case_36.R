...
test_that("Test case 36",{
  ...
  #Constraint 5:
  Const_5 <- matrix(c(-10,-4,-8,-4,10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                      rep(0,N),-1,-5,-2,-1,1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);
