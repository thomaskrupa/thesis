...
test_that("Test case 75",{
  ...
  Righthandside_i1 <- c(Input[1,], Output[1,], rep(1,K), 0.894,0.894,0.362,0.362);
  Righthandside_i2 <- c(Input[2,], Output[2,], rep(1,K), 0.678,0.678,0.188,0.188);
  Righthandside_i3 <- c(Input[3,], Output[3,], rep(1,K), 0.836,0.836,0.207,0.207);
  Righthandside_i4 <- c(Input[4,], Output[4,], rep(1,K), 0.869,0.869,0.516,0.516);
  Righthandside_i5 <- c(Input[5,], Output[5,], rep(1,K), 0.693,0.693,0.407,0.407);
  Righthandside_i6 <- c(Input[6,], Output[6,], rep(1,K), 0.966,0.966,0.269,0.269);
  Righthandside_i7 <- c(Input[7,], Output[7,], rep(1,K), 0.647,0.647,0.257,0.257);
  Righthandside_i8 <- c(Input[8,], Output[8,], rep(1,K), 0.756,0.756,0.103,0.103);
  Righthandside_i9 <- c(Input[9,], Output[9,], rep(1,K), 1.191,1.191,0.402,0.402);
  Righthandside_i10 <- c(Input[10,], Output[10,], rep(1,K), 0.792,0.792,0.187,0.187);
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/0.838),-(w2/0.277),-(w3/0.962)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/1.233),-(w2/0.132),-(w3/0.443)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/0.321),-(w2/0.045),-(w3/0.482)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/1.483),-(w2/0.111),-(w3/0.467)), byrow = TRUE, nrow = 1);
  obj_func_i5 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/1.592),-(w2/0.208),-(w3/1.073)), byrow = TRUE, nrow = 1);
  obj_func_i6 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/0.790),-(w2/0.139),-(w3/0.545)), byrow = TRUE, nrow = 1);
  obj_func_i7 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/0.451),-(w2/0.075),-(w3/0.366)), byrow = TRUE, nrow = 1);
  obj_func_i8 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/0.408),-(w2/0.074),-(w3/0.229)), byrow = TRUE, nrow = 1);
  obj_func_i9 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/1.864),-(w2/0.061),-(w3/0.691)), byrow = TRUE, nrow = 1);
  obj_func_i10 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(w1/1.222),-(w2/0.149),-(w3/0.337)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 5:
  Const_5_i1 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i2 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i3 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i4 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i5 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i6 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i7 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i8 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i9 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));

  Const_5_i10 <- matrix(c(0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = (2*sum_l));
