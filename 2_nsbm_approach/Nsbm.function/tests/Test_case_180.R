...
test_that("Test case 180",{


  #Righthand side and Direction
  Righthandside_i1 <- c(Input[1,], Output[1,], 10,10,1,1);
  Righthandside_i2 <- c(Input[2,], Output[2,], 4,4,5,5);
  Righthandside_i3 <- c(Input[3,], Output[3,], 8,8,2,2);
  Righthandside_i4 <- c(Input[4,], Output[4,], 4,4,1,1);
