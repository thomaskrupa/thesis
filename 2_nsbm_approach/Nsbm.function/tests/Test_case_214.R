...
test_that("Test case 214",{
  ...
  Output_vec_res_2 <- matrix(c(1/600,
                               1/1800,
                               1/900), byrow = TRUE, nrow = 3);



  # Adjustment Output for the obj function and constraint1:
  Output_N <- matrix(c(5,1/600,
                       2,1/1800,
                       1,1/900), byrow = TRUE, nrow = 3);
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),(0.5/(5)),(0.5/(1/600)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),(0.5/(2)),(0.5/(1/1800)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),(0.5/(1)),(0.5/(1/900)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
