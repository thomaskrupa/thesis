...
Data_1 <- matrix(c(3,8,1,2,
                   7,4,5,8,
                   2,3,2,1,
                   4,1,2,5),byrow=TRUE, nrow=4);
...
test_that("Test case 61",{
  ...
  Const_1_i1 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/1),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i2 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i3 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i4 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 3:
  Const_3_i1 <- matrix(c(-1,rep(0,N),1,5,2,2,-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i2 <- matrix(c(-5,rep(0,N),1,5,2,2,-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i3 <- matrix(c(-2,rep(0,N),1,5,2,2,-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i4 <- matrix(c(-2,rep(0,N),1,5,2,2,-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);
