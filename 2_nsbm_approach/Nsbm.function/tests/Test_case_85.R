...
Amount = matrix(c(1,1,0,1,1), byrow=TRUE, nrow=1);
Amount_Input =  c(1,0);
Amount_Output = c(1,1);
Amount_Link = c(1);
...
test_that("Test case 85",{


  # Slack_transformation:
  weightsNSBM <- matrix(c(  1,2,2,2,2,2,2,3,3,4,
                            1,2,2,2,2,2,2,3,3,4,
                            1,2,2,2,2,2,2,3,3,4), byrow = TRUE, nrow = 3);
