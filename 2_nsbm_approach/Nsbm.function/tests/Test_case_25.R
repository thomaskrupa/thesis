...
Link = matrix(c(2,8,1,5), byrow = TRUE, nrow = 4);
...
test_that("Test case 25",{
  ...
  Const_1_i1 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/5),(0.5/1),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i2 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/1), (0.5/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i3 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/5), (0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i4 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/8), (0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);

  obj_func_i1 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/3),-(0.5/8)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/7),-(0.5/4)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/2),-(0.5/3)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/4),-(0.5/1)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 2:
  Const_2_i1 <- matrix(c(-3,3,7,2,4,rep(0,N),rep(0,sum_r),1,0,
                         -8,rep(0,N),8,4,3,1,rep(0,sum_r),0,1), byrow = TRUE, nrow = 2);

  Const_2_i2 <- matrix(c(-7,3,7,2,4,rep(0,N),rep(0,sum_r),1,0,
                         -4,rep(0,N),8,4,3,1,rep(0,sum_r),0,1), byrow = TRUE, nrow = 2);

  Const_2_i3 <- matrix(c(-2,3,7,2,4,rep(0,N),rep(0,sum_r),1,0,
                         -3,rep(0,N),8,4,3,1,rep(0,sum_r),0,1), byrow = TRUE, nrow = 2);

  Const_2_i4 <- matrix(c(-4,3,7,2,4,rep(0,N),rep(0,sum_r),1,0,
                         -1,rep(0,N),8,4,3,1,rep(0,sum_r),0,1), byrow = TRUE, nrow = 2);

  #Constraint 3:
  Const_3_i1 <- matrix(c(-5,5,1,5,8,rep(0,N),-1,0,rep(0,sum_m),
                         -1,rep(0,N),1,5,2,2,0,-1,rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_3_i2 <- matrix(c(-1,5,1,5,8,rep(0,N),-1,0,rep(0,sum_m),
                         -5,rep(0,N),1,5,2,2,0,-1,rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_3_i3 <- matrix(c(-5,5,1,5,8,rep(0,N),-1,0,rep(0,sum_m),
                         -2,rep(0,N),1,5,2,2,0,-1,rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_3_i4 <- matrix(c(-8,5,1,5,8,rep(0,N),-1,0,rep(0,sum_m),
                         -2,rep(0,N),1,5,2,2,0,-1,rep(0,sum_m)), byrow = TRUE, nrow = 2);

  #COnstraint 4:
  Const_4 <- matrix(c(-1,rep(1,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                      -1,rep(0,N),rep(1,N),rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);

  #Constraint 5:
  Const_5_i1 <- matrix(c(-2,2,8,1,5,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -2,rep(0,N),2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_5_i2 <- matrix(c(-8,2,8,1,5,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -8,rep(0,N),2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_5_i3 <- matrix(c(-1,2,8,1,5,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -1,rep(0,N),2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_5_i4 <- matrix(c(-5,2,8,1,5,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -5,rep(0,N),2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);

  #t Constraint:
  Const_t <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 1);
