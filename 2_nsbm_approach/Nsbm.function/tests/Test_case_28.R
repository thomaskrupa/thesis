...
test_that("Test case 28",{
  ...
  Const_2_i2 <- matrix(c(-7,3,7,2,4,rep(0,N),rep(0,sum_m),1,0,
                         -4,rep(0,N),8,4,3,1,rep(0,sum_m),0,1), byrow = TRUE, nrow = 2);
  ...
  #Constraint 5:
  Const_5 <- matrix(c(0,-2,-8,-1,-5,2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 1);
