...
test_that("Test case 24",{
  ...
  obj_func_i1 <- matrix(c(rep(0,(K*N)),(0.5/6),(0.5/2),(0.5/12),(0.5/4),(0.5/16),(0.5/4),rep(0,sum_r)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,(K*N)),(0.5/16),(0.5/2),(0.5/2),(0.5/2),(0.5/4),(0.5/4),rep(0,sum_r)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,(K*N)),(0.5/14),(0.5/8),(0.5/10),(0.5/8),(0.5/14),(0.5/2),rep(0,sum_r)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 5:
  Const_5 <- matrix(c(-10,-4,-8,10,4,8,rep(0,K),rep(0,sum_r),rep(0,sum_m),
                      -5,-7,-4,5,7,4,rep(0,K),rep(0,sum_r),rep(0,sum_m),
                      rep(0,N),-1,-5,-2,1,5,2,rep(0,sum_r),rep(0,sum_m),
                      rep(0,N),-4,-3,-2,4,3,2,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);
