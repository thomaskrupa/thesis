...
test_that("Test case 257",{
  ...
  #Constraint 5:
  Const_5_i1 <- matrix(c(0,-10,-4,-8,10,4,8,rep(0,N),rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l)),
                         0,rep(0,N),-1,-5,-2,1,5,2,rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l))), byrow = TRUE, nrow = 2);

  Const_5_i2 <- matrix(c(0,-10,-4,-8,10,4,8,rep(0,N),rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l)),
                         0,rep(0,N),-1,-5,-2,1,5,2,rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l))), byrow = TRUE, nrow = 2);

  Const_5_i3 <- matrix(c(0,-10,-4,-8,10,4,8,rep(0,N),rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l)),
                         0,rep(0,N),-1,-5,-2,1,5,2,rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l))), byrow = TRUE, nrow = 2);
