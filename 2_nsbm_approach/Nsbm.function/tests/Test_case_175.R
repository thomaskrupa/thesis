...
Data_1 <- matrix(c(3, 1, 5, 8, 1, 2,
                   7, 1, 1, 4, 5, 8,
                   2, 1, 5, 3, 2, 1),byrow=TRUE, nrow=3);


Input = matrix(c(3, 1, 8,
                 7, 1, 4,
                 2, 1, 3), byrow = TRUE, nrow = 3);
...
test_that("Test case 175",{


  #Righthand side and Direction and NIRS = 1 adjusted
  Righthandside_i1 <- c(Input[1,], Output[1,], 2,2);
  Righthandside_i2 <- c(Input[2,], Output[2,], 8,8);
  Righthandside_i3 <- c(Input[3,], Output[3,], 1,1);
