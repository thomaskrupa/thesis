...
test_that("Test case 31",{
  ...
  Const_1_i1 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,N),(0.5/3),(0.5/6),(0.5/8),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i2 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,N),(0.5/8),(0.5/1),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i3 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,N),(0.5/7),(0.5/5),(0.5/7),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i4 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,N),(0.5/1),(0.5/8),(0.5/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);

  obj_func_i1 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/7),-(0.5/5),-(0.5/7)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/4),-(0.5/2),-(0.5/3)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/1),-(0.5/5),-(0.5/6)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/2),-(0.5/4),-(0.5/3)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 5:
  Const_5_i1 <- matrix(c(-10,10,4,8,4,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -10,rep(0,N),10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -1,rep(0,N),1,5,2,1,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -1,rep(0,N),rep(0,N),1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);

  Const_5_i2 <- matrix(c(-4,10,4,8,4,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -4,rep(0,N),10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -5,rep(0,N),1,5,2,1,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -5,rep(0,N),rep(0,N),1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);

  Const_5_i3 <- matrix(c(-8,10,4,8,4,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -8,rep(0,N),10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -2,rep(0,N),1,5,2,1,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -2,rep(0,N),rep(0,N),1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);

  Const_5_i4 <- matrix(c(-4,10,4,8,4,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -4,rep(0,N),10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -1,rep(0,N),1,5,2,1,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         -1,rep(0,N),rep(0,N),1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);
