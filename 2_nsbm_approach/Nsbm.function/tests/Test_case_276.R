...
test_that("Test case 276",{


  # Division efficiency
  DivEffNSBM <- matrix(c(0.633,0.339,0.393,
                         0.348,1.000,1.000,
                         1.000,1.000,0.919,
                         0.297,1.000,1.000,
                         0.263,1.000,0.377,
                         ...
                         0.922,1.000,1.000,
                         1.000,1.000,0.581,
                         0.287,0.377,1.000),byrow = TRUE, nrow = 10);



  # Efficiency results
  EfficiencyNSBM <- matrix(c(0.478,0.739,0.968,0.719,0.456,0.719,0.947,0.969,0.832,0.590), byrow = TRUE, nrow = 10);
