...
test_that("Test case 14",{
  ...
  obj_func_i1 <- matrix(c(rep(0,3),rep(0,3),rep(0,4),-(0.5/6),-(0.5/8),-(0.5/16),-(0.5/6)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,3),rep(0,3),rep(0,4),-(0.5/14),-(0.5/2),-(0.5/8),-(0.5/2)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,3),rep(0,3),rep(0,4),-(0.5/4),-(0.5/16),-(0.5/6),-(0.5/10)), byrow = TRUE, nrow = 1);
