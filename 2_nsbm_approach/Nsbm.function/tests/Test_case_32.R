...
test_that("Test case 32",{
  ...
  Righthandside_i1 <- c(Input[1,], Output[1,], rep(1,K), 10,10,1,1);
  Righthandside_i2 <- c(Input[2,], Output[2,], rep(1,K), 4,4,5,5);
  Righthandside_i3 <- c(Input[3,], Output[3,], rep(1,K), 8,8,2,2);
  Righthandside_i4 <- c(Input[4,], Output[4,], rep(1,K), 4,4,1,1);
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/7),-(0.5/5),-(0.5/7)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/4),-(0.5/2),-(0.5/3)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/1),-(0.5/5),-(0.5/6)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/2),-(0.5/4),-(0.5/3)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 2:
  Const_2_i1 <- matrix(c(7,4,1,2,rep(0,N),rep(0,N),rep(0,sum_r),1,0,0,
                         rep(0,N),5,2,5,4,rep(0,N),rep(0,sum_r),0,1,0,
                         rep(0,N),rep(0,N),7,3,6,3,rep(0,sum_r),0,0,1), byrow = TRUE, nrow = 3);

  Const_2_i2 <- matrix(c(7,4,1,2,rep(0,N),rep(0,N),rep(0,sum_r),1,0,0,
                         rep(0,N),5,2,5,4,rep(0,N),rep(0,sum_r),0,1,0,
                         rep(0,N),rep(0,N),7,3,6,3,rep(0,sum_r),0,0,1), byrow = TRUE, nrow = 3);

  Const_2_i3 <- matrix(c(7,4,1,2,rep(0,N),rep(0,N),rep(0,sum_r),1,0,0,
                         rep(0,N),5,2,5,4,rep(0,N),rep(0,sum_r),0,1,0,
                         rep(0,N),rep(0,N),7,3,6,3,rep(0,sum_r),0,0,1), byrow = TRUE, nrow = 3);

  Const_2_i4 <- matrix(c(7,4,1,2,rep(0,N),rep(0,N),rep(0,sum_r),1,0,0,
                         rep(0,N),5,2,5,4,rep(0,N),rep(0,sum_r),0,1,0,
                         rep(0,N),rep(0,N),7,3,6,3,rep(0,sum_r),0,0,1), byrow = TRUE, nrow = 3);


  #Constraint 3:
  Const_3_i1 <- matrix(c(3,8,7,1,rep(0,N),rep(0,N),-1,0,0,rep(0,sum_m),
                         rep(0,N),6,1,5,8,rep(0,N),0,-1,0,rep(0,sum_m),
                         rep(0,N),rep(0,N),8,2,7,5,0,0,-1,rep(0,sum_m)), byrow = TRUE, nrow = 3);

  Const_3_i2 <- matrix(c(3,8,7,1,rep(0,N),rep(0,N),-1,0,0,rep(0,sum_m),
                         rep(0,N),6,1,5,8,rep(0,N),0,-1,0,rep(0,sum_m),
                         rep(0,N),rep(0,N),8,2,7,5,0,0,-1,rep(0,sum_m)), byrow = TRUE, nrow = 3);

  Const_3_i3 <- matrix(c(3,8,7,1,rep(0,N),rep(0,N),-1,0,0,rep(0,sum_m),
                         rep(0,N),6,1,5,8,rep(0,N),0,-1,0,rep(0,sum_m),
                         rep(0,N),rep(0,N),8,2,7,5,0,0,-1,rep(0,sum_m)), byrow = TRUE, nrow = 3);

  Const_3_i4 <- matrix(c(3,8,7,1,rep(0,N),rep(0,N),-1,0,0,rep(0,sum_m),
                         rep(0,N),6,1,5,8,rep(0,N),0,-1,0,rep(0,sum_m),
                         rep(0,N),rep(0,N),8,2,7,5,0,0,-1,rep(0,sum_m)), byrow = TRUE, nrow = 3);
  ...
  vrs_constraint <- matrix(c(rep(1,N),rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                           ...
                           rep(0,N),rep(0,N),rep(1,N),rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 3);

  #Constraint 5:
  Const_5_i1 <- matrix(c(10,4,8,4,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),1,5,2,1,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);

  Const_5_i2 <- matrix(c(10,4,8,4,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),1,5,2,1,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);

  Const_5_i3 <- matrix(c(10,4,8,4,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),1,5,2,1,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);

  Const_5_i4 <- matrix(c(10,4,8,4,rep(0,N),rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),10,4,8,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),1,5,2,1,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),rep(0,N),1,5,2,1,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 4);
