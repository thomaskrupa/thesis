...
test_that("Test case 206",{
  ...
  Const_1_i1 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/(1/1800)),(0.5/1),rep(0,2)), byrow = TRUE, nrow = 1);
  Const_1_i2 <- matrix(c(1,rep(0,N),rep(0,N),(0.5/(1/600)), (0.5/(1/7)),rep(0,2)), byrow = TRUE, nrow = 1);
