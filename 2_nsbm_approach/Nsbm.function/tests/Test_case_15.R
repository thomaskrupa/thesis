...
Input = matrix(c(3,4,8,3,
                 7,1,4,1,
                 2,8,3,5), byrow = TRUE, nrow = 3);

Output = matrix(c(5,7,1,7,
                  1,5,5,7,
                  5,6,2,1), byrow = TRUE, nrow = 3);
...
test_that("Test case 15",{
  ...
  Righthandside_i1 <- c(Input[1, ], Output[1, ], rep(1,K), 2,5,2,5);
  Righthandside_i2 <- c(Input[2, ], Output[2, ], rep(1,K), 8,1,8,1);
  Righthandside_i3 <- c(Input[3, ], Output[3, ], rep(1,K), 1,2,1,2);
  ...
  obj_func_i1 <- matrix(c(rep(0,3),rep(0,3),(0.5/10),(0.5/14),(0.5/2),(0.5/14),rep(0,4)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,3),rep(0,3),(0.5/2),(0.5/10),(0.5/10),(0.5/14),rep(0,4)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,3),rep(0,3),(0.5/10),(0.5/12),(0.5/4),(0.5/2),rep(0,4)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 2:
  Const_2_i1 <- matrix(c(3,7,2,rep(0,3),rep(0,4),1,0,0,0,
                         4,1,8,rep(0,3),rep(0,4),0,1,0,0,
                         rep(0,3),8,4,3,rep(0,4),0,0,1,0,
                         rep(0,3),3,1,5,rep(0,4),0,0,0,1), byrow = TRUE, nrow = 4);
  Const_2_i2 <- matrix(c(3,7,2,rep(0,3),rep(0,4),1,0,0,0,
                         4,1,8,rep(0,3),rep(0,4),0,1,0,0,
                         rep(0,3),8,4,3,rep(0,4),0,0,1,0,
                         rep(0,3),3,1,5,rep(0,4),0,0,0,1), byrow = TRUE, nrow = 4);
  Const_2_i3 <- matrix(c(3,7,2,rep(0,3),rep(0,4),1,0,0,0,
                         4,1,8,rep(0,3),rep(0,4),0,1,0,0,
                         rep(0,3),8,4,3,rep(0,4),0,0,1,0,
                         rep(0,3),3,1,5,rep(0,4),0,0,0,1), byrow = TRUE, nrow = 4);

  #Constraint 3:
  Const_3_i1 <- matrix(c(5,1,5,rep(0,3),-1,0,0,0,rep(0,4),
                         7,5,6,rep(0,3),0,-1,0,0,rep(0,4),
                         rep(0,3),1,5,2,0,0,-1,0,rep(0,4),
                         rep(0,3),7,7,1,0,0,0,-1,rep(0,4)), byrow = TRUE, nrow = 4);
  Const_3_i2 <- matrix(c(5,1,5,rep(0,3),-1,0,0,0,rep(0,4),
                         7,5,6,rep(0,3),0,-1,0,0,rep(0,4),
                         rep(0,3),1,5,2,0,0,-1,0,rep(0,4),
                         rep(0,3),7,7,1,0,0,0,-1,rep(0,4)), byrow = TRUE, nrow = 4);
  Const_3_i3 <- matrix(c(5,1,5,rep(0,3),-1,0,0,0,rep(0,4),
                         7,5,6,rep(0,3),0,-1,0,0,rep(0,4),
                         rep(0,3),1,5,2,0,0,-1,0,rep(0,4),
                         rep(0,3),7,7,1,0,0,0,-1,rep(0,4)), byrow = TRUE, nrow = 4);

  #VRS Constraint:
  vrs_constraint <- matrix(c(rep(1,3),rep(0,3),rep(0,4),rep(0,4),
                           rep(0,3),rep(1,3),rep(0,4),rep(0,4)), byrow = TRUE, nrow = 2);

  #Constraint 5:
  Const_5_i1 <- matrix(c(2,8,1,rep(0,3),rep(0,4),rep(0,4),
                         5,1,2,rep(0,3),rep(0,4),rep(0,4),
                         rep(0,3),2,8,1,rep(0,4),rep(0,4),
                         rep(0,3),5,1,2,rep(0,4),rep(0,4)), byrow = TRUE, nrow = 4);
  Const_5_i2 <- matrix(c(2,8,1,rep(0,3),rep(0,4),rep(0,4),
                         5,1,2,rep(0,3),rep(0,4),rep(0,4),
                         rep(0,3),2,8,1,rep(0,4),rep(0,4),
                         rep(0,3),5,1,2,rep(0,4),rep(0,4)), byrow = TRUE, nrow = 4);
  Const_5_i3 <- matrix(c(2,8,1,rep(0,3),rep(0,4),rep(0,4),
                         5,1,2,rep(0,3),rep(0,4),rep(0,4),
                         rep(0,3),2,8,1,rep(0,4),rep(0,4),
                         rep(0,3),5,1,2,rep(0,4),rep(0,4)), byrow = TRUE, nrow = 4);
