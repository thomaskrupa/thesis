...
test_that("Test case 119",{


  # Slack_transformation:
  weightsNSBM <- matrix(c(  2,2,2,2,2,2,3,3,4,4,
                            2,2,2,2,2,2,3,3,4,4,
                            2,2,2,2,2,2,3,3,4,4), byrow = TRUE, nrow = 3);
  ...
  slack_minus <- matrix(c(  4,4,
                            4,4,
                            4,4), byrow = TRUE, nrow = 3);



  # nsbm_division

  DivEffNSBM <- matrix(c( 0.5,4/7,
                          0.5,4/7,
                          0.5,4/7), byrow = TRUE, nrow = 3);
  ...
  Link_proj <- matrix(c(12,14,
                        12,14,
                        12,14), byrow = TRUE, nrow = 3);
