...
Data_1 <- matrix(c(1, 1, 1, 2, 1, 1, 2,
                   2, 1, 1, 1, 2, 1, 1,
                   2, 1, 2, 1, 1, 1, 1),byrow=TRUE, nrow=3);
...
test_that("Test case 271",{


  # weightsNSBM
  weightsNSBM <- matrix(c(1,rep(2,(K*N)),1,2,3,4,6,7,8,9,10,11,
                          1,rep(2,(K*N)),2,3,4,5,7,8,9,10,11,12,
                          1,rep(2,(K*N)),3,4,5,6,8,9,10,11,12,13), byrow = TRUE, nrow = 3);
  ...
  # slack_minus
  slack_minus <- matrix(c(3,4,9,10,11,
                          4,5,10,11,12,
                          5,6,11,12,13), byrow = TRUE, nrow = 3);
  ...
  nsbm.div_res <- matrix(c(  -2/4.5, -8/6.5, -(16.5/3)/2,
                             -1/3.75, -4/9.5, -(25/3)/4,
                             -1.5/6.5, -10/10.5, -(25/3)/5), byrow = TRUE, nrow = 3);
