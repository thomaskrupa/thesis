...
test_that("Test case 56",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/3)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/7)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/2)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/4)), byrow = TRUE, nrow = 1);
