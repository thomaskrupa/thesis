...
Amount = matrix(c(1,2,1,1,1), byrow=TRUE, nrow=1);
Amount_Input =  c(1,1);
Amount_Output = c(2,1);
Amount_Link = c(1);
...
test_that("Test case 88",{


  # Slack_transformation:
  weightsNSBM <- matrix(c(  1,2,2,2,2,2,2,3,3,3,4,4,
                            1,2,2,2,2,2,2,3,3,3,4,4,
                            1,2,2,2,2,2,2,3,3,3,4,4), byrow = TRUE, nrow = 3);
  ...
  DivEffNSBM <- matrix(c( -72/45,-5/8,
                          -72/45,-5/8,
                          -72/45,-5/8), byrow = TRUE, nrow = 3);
