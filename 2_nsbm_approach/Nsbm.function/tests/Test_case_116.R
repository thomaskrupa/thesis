...
test_that("Test case 116",{


  # Slack_transformation:
  weightsNSBM <- matrix(c(  2,2,2,2,2,2,3,3,3,4,4,
                            2,2,2,2,2,2,3,3,3,4,4,
                            2,2,2,2,2,2,3,3,3,4,4), byrow = TRUE, nrow = 3);
  ...
  DivEffNSBM <- matrix(c( 24/45,5/8,
                          24/45,5/8,
                          24/45,5/8), byrow = TRUE, nrow = 3);
