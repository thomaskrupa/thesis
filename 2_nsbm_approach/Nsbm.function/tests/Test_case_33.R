...
test_that("Test case 33",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),(0.5/3),(0.5/6),(0.5/8),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),(0.5/8),(0.5/1),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),(0.5/7),(0.5/5),(0.5/7),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),(0.5/1),(0.5/8),(0.5/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
