...
Data_1 <- matrix(c(3, 0, 8, 0, 2,
                   7, 0, 4, 0, 8,
                   2, 0, 3, 0, 1),byrow=TRUE, nrow=3);
...
test_that("Test case 215",{
  ...
  Output_vec_res_1 <- matrix(c(1/300,
                               1/300,
  ...
  Output_vec_res_2 <-  matrix(c(1/300,
                                1/300,
                                1/300), byrow = TRUE, nrow = 3);


  # Adjustment Output for the obj function and constraint1:
  Output_N <- matrix(c(1/300,1/300,
                       1/300,1/300,
                       1/300,1/300), byrow = TRUE, nrow = 3);
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),(0.5/(1/300)),(0.5/(1/300)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),(0.5/(1/300)),(0.5/(1/300)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),(0.5/(1/300)),(0.5/(1/300)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
