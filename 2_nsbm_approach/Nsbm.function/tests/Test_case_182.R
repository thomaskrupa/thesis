...
Data_1 <- matrix(c(7,3,5,6,7,8,10,
                   4,8,2,1,3,2,4,
                   1,7,5,5,6,7,8,
                   2,1,4,8,3,5,4),byrow=TRUE, nrow=4);
...
test_that("Test case 182",{



  #Righthand side and Direction
  Righthandside_i1 <- c(Input[1,], Output[1,], 10,10);
  Righthandside_i2 <- c(Input[2,], Output[2,], 4,4);
  Righthandside_i3 <- c(Input[3,], Output[3,], 8,8);
  Righthandside_i4 <- c(Input[4,], Output[4,], 4,4);

  Direction_ <- c(rep("=",sum_m), rep("=",sum_r),rep("=",(2*sum_l)));
