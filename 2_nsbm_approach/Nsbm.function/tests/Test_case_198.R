...
Data_1 <- matrix(c(3, 8, 5, 1,
                   7, 4, 1, 5,
                   2, 3, 5, 2),byrow=TRUE, nrow=3);
...
test_that("Test case 198",{


  #Righthandside_and_ Direction:
  Righthandside <- c(1, rep(0,1,sum_m), rep(0,1,sum_r), 0);

  # NIRS = 1 adjusted
  Direction_ <- c("=", rep("=",1,sum_m), rep("=",1,sum_r), ">");
