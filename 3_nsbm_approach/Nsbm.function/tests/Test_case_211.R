...
test_that("Test case 211",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),(0.5/(1/300)),(0.5/1),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),(0.5/(1/300)),(0.5/(1/7)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),(0.5/(1/300)),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
