...
test_that("Test case 77",{
  ...
  #Constraint 5:
  Const_5 <- matrix(c(0,-0.894,-0.678,-0.836,-0.869,-0.693,-0.966,-0.647,-0.756,-1.191,-0.792,0.894,0.678,0.836,0.869,0.693,0.966,0.647,0.756,1.191,0.792,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                      0,rep(0,N),-0.362,-0.188,-0.207,-0.516,-0.407,-0.269,-0.257,-0.103,-0.402,-0.187,0.362,0.188,0.207,0.516,0.407,0.269,0.257,0.103,0.402,0.187,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = sum_l);
