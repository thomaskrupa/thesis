...
Data_1 <- matrix(c(3, 5, -8, 0,
                   7, 1, 0, 0,
                   2, 5, 0, 0),byrow=TRUE, nrow=3);
...
test_that("Test case 221",{
  ...
  Output_vec_res_1 <- matrix(c(1/2700,
                               1/300,
  ...
  Output_N <- matrix(c(1/2700,1/300,
                       1/300,1/300,
  ...
  obj_func_i1 <- matrix(c(rep(0,N),(0.5/(1/2700)),(0.5/(1/300)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),(0.5/(1/300)),(0.5/(1/300)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),(0.5/(1/300)),(0.5/(1/300)),rep(0,sum_m)), byrow = TRUE, nrow = 1);
