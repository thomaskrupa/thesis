...
test_that("Test case 129",{


  #Righthandside_and_ Direction:
  Righthandside <- c(1, rep(0,1,sum_m), rep(0,1,sum_r), rep(0,1,K), rep(0,1,(2*sum_l)), 0);

  # NIRS = 1 adjusted
  Direction_ <- c("=", rep("=",1,sum_m), rep("=",1,sum_r), rep("<=",1,K), rep("=",1,(2*sum_l)), ">");
