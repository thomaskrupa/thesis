...
test_that("Test case 39",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),(w1/5),(w2/1),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),(w1/1),(w2/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),(w1/5),(w2/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),(w1/8),(w2/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
