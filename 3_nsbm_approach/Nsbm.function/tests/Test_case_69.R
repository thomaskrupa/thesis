...
test_that("Test case 69",{
  ...
  Righthandside_i1 <- c(Input[1,], Output[1,], rep(1,K), 2,2);
  Righthandside_i2 <- c(Input[2,], Output[2,], rep(1,K), 8,8);
  Righthandside_i3 <- c(Input[3,], Output[3,], rep(1,K), 1,1);
  Righthandside_i4 <- c(Input[4,], Output[4,], rep(1,K), 5,5);
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),(0.5/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),(0.5/1),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),(0.5/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),(0.5/8),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  ...
  Const_2_i2 <- matrix(c(3,7,2,4,rep(0,N),rep(0,sum_r),1,0,
                         rep(0,N),8,4,3,1,rep(0,sum_r),0,1), byrow = TRUE, nrow = 2);
  ...
  #Constraint 3:
  Const_3_i1 <- matrix(c(5,1,5,8,rep(0,N),-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i2 <- matrix(c(5,1,5,8,rep(0,N),-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i3 <- matrix(c(5,1,5,8,rep(0,N),-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i4 <- matrix(c(5,1,5,8,rep(0,N),-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 5:
  Const_5_i1 <- matrix(c(2,8,1,5,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_5_i2 <- matrix(c(2,8,1,5,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_5_i3 <- matrix(c(2,8,1,5,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);

  Const_5_i4 <- matrix(c(2,8,1,5,rep(0,N),rep(0,sum_r),rep(0,sum_m),
                         rep(0,N),2,8,1,5,rep(0,sum_r),rep(0,sum_m)), byrow = TRUE, nrow = 2);
