...
test_that("Test case 275",{
  ...
  weightsNSBM <- matrix(c(2,rep(2,(K*N)),rep(3,(sum_r)), rep(4,(sum_m)), rep(5,(sum_l)), rep(6,(sum_l)),
                          ...
                          4,rep(2,(K*N)),rep(11,(sum_r)), rep(12,(sum_m)), rep(13,(sum_l)), rep(14,(sum_l))), byrow = TRUE, nrow = 3);

  # slack_plus
  slack_plus <- matrix(c(rep(3/2,(sum_r)),rep(5/2,(sum_l)),
                         rep(7/1,(sum_r)),rep(9/1,(sum_l)),
                         rep(11/4,(sum_r)),rep(13/4,(sum_l))), byrow = TRUE, nrow = 3);

  # slack_minus
  slack_minus <- matrix(c(rep(4/2,(sum_r)),rep(6/2,(sum_l)),
                          rep(8/1,(sum_r)),rep(10/1,(sum_l)),
                          rep(12/4,(sum_r)),rep(14/4,(sum_l))), byrow = TRUE, nrow = 3);
