...
test_that("Test case 51",{
  ...
  #Constraint 2:
  Const_2_i1 <- matrix(c(rep(0,N),8,4,3,1,rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i2 <- matrix(c(rep(0,N),8,4,3,1,rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i3 <- matrix(c(rep(0,N),8,4,3,1,rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i4 <- matrix(c(rep(0,N),8,4,3,1,rep(0,sum_r),1), byrow = TRUE, nrow = 1);
