...
test_that("Test case 13",{
  ...
  #Constraint 5:
  Const_5_i1 <- matrix(c(-2,2,8,1,rep(0,3),rep(0,4),rep(0,4),
                         -5,5,1,2,rep(0,3),rep(0,4),rep(0,4),
                         -2,rep(0,3),2,8,1,rep(0,4),rep(0,4),
                         -5,rep(0,3),5,1,2,rep(0,4),rep(0,4)), byrow = TRUE, nrow = 4);
  Const_5_i2 <- matrix(c(-8,2,8,1,rep(0,3),rep(0,4),rep(0,4),
                         -1,5,1,2,rep(0,3),rep(0,4),rep(0,4),
                         -8,rep(0,3),2,8,1,rep(0,4),rep(0,4),
                         -1,rep(0,3),5,1,2,rep(0,4),rep(0,4)), byrow = TRUE, nrow = 4);
  Const_5_i3 <- matrix(c(-1,2,8,1,rep(0,3),rep(0,4),rep(0,4),
                         -2,5,1,2,rep(0,3),rep(0,4),rep(0,4),
                         -1,rep(0,3),2,8,1,rep(0,4),rep(0,4),
                         -2,rep(0,3),5,1,2,rep(0,4),rep(0,4)), byrow = TRUE, nrow = 4);
