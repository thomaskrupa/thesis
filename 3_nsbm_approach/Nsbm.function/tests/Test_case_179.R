...
test_that("Test case 179",{


  #Righthand side and Direction
  Righthandside_i1 <- c(Input[1,], Output[1,], 2,1,2,1);
  Righthandside_i2 <- c(Input[2,], Output[2,], 8,1,8,1);
  Righthandside_i3 <- c(Input[3,], Output[3,], 1,1,1,1);
