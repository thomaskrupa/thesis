...
Amount = matrix(c(1,1,1,0,1), byrow=TRUE, nrow=1);
Amount_Input =  c(1,1);
Amount_Output = c(1,0);
Amount_Link = c(1);
...
test_that("Test case 83",{


  # Slack_transformation:
  weightsNSBM <- matrix(c(  1,2,2,2,2,2,2,3,4,4,
                            1,2,2,2,2,2,2,3,4,4,
                            1,2,2,2,2,2,2,3,4,4), byrow = TRUE, nrow = 3);
  ...
  DivEffNSBM <- matrix(c( -1.5,-1,
                          -1.5,-1,
                          -1.5,-1), byrow = TRUE, nrow = 3);
