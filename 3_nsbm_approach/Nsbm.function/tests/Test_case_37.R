...
test_that("Test case 37",{
  ...
  Const_1_i1 <- matrix(c(1,rep(0,N),rep(0,N),(w1/5),(w2/1),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i2 <- matrix(c(1,rep(0,N),rep(0,N),(w1/1), (w2/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i3 <- matrix(c(1,rep(0,N),rep(0,N),(w1/5), (w2/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  Const_1_i4 <- matrix(c(1,rep(0,N),rep(0,N),(w1/8), (w2/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);

  obj_func_i1 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(w1/3),-(w2/8)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(w1/7),-(w2/4)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(w1/2),-(w2/3)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(w1/4),-(w2/1)), byrow = TRUE, nrow = 1);
