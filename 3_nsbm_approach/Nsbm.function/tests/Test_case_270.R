...
Data_1 <- matrix(c(1, 1, 1, 2, 1, 1,
                   2, 1, 1, 1, 2, 1,
                   2, 1, 2, 1, 1, 1),byrow=TRUE, nrow=3);
...
Amount = c(1,1,0,0,1,1,1,1);
Amount_Input = c(1,0,1);
...
test_that("Test case 270",{


  # weightsNSBM
  weightsNSBM <- matrix(c(1,rep(2,(K*N)),1,3,4,6,7,8,9,10,
                          1,rep(2,(K*N)),2,4,5,7,8,9,10,11,
                          1,rep(2,(K*N)),3,5,6,8,9,10,11,12), byrow = TRUE, nrow = 3);

  # slack_plus
  slack_plus <- matrix(c(1,3,7,8,
                         2,4,8,9,
                         3,5,9,10), byrow = TRUE, nrow = 3);

  # slack_minus
  slack_minus <- matrix(c(4,6,9,10,
                          5,7,10,11,
                          6,8,11,12), byrow = TRUE, nrow = 3);
  ...
  nsbm.div_res <- matrix(c(  -3/5, -8/9, -7/2.5,
                             -1.5/4, -4/10, -8/5,
                             -2/7, -10/11, -7/6), byrow = TRUE, nrow = 3);
