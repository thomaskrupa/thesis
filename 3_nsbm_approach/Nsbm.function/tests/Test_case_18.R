...
test_that("Test case 18",{
  ...
  Righthandside_i1 <- c(Input[1, ], Output[1, ], rep(1,K), rep(0,K));
  Righthandside_i2 <- c(Input[2, ], Output[2, ], rep(1,K), rep(0,K));
  Righthandside_i3 <- c(Input[3, ], Output[3, ], rep(1,K), rep(0,K));
  ...
  #Constraint 5:
  Const_5 <- matrix(c(-2,-8,-1,2,8,1,rep(0,4),rep(0,4),
                      -5,-1,-2,5,1,2,rep(0,4),rep(0,4)), byrow = TRUE, nrow = 2);
