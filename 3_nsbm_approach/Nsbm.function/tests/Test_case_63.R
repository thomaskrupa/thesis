...
test_that("Test case 63",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),(0.5/1),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),(0.5/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 3:
  Const_3_i1 <- matrix(c(rep(0,N),1,5,2,2,-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i2 <- matrix(c(rep(0,N),1,5,2,2,-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i3 <- matrix(c(rep(0,N),1,5,2,2,-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);

  Const_3_i4 <- matrix(c(rep(0,N),1,5,2,2,-1,rep(0,sum_m)), byrow = TRUE, nrow = 1);
