...
Output <- matrix(c(3,4,6,
                   3,4,6,
                   3,4,6), byrow = TRUE, nrow = 3);
...
Amount = matrix(c(1,1,1,2,1), byrow=TRUE, nrow=1);
Amount_Input =  c(1,1);
Amount_Output = c(1,2);
Amount_Link = c(1);
...
test_that("Test case 89",{
  ...
  DivEffNSBM <- matrix(c( -1.5,-24/39,
                          -1.5,-24/39,
                          -1.5,-24/39), byrow = TRUE, nrow = 3);
  ...
  Output_proj  <- matrix(c(  6,7,9,
                             6,7,9,
                             6,7,9), byrow = TRUE, nrow = 3);
