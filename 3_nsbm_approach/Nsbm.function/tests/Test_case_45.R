...
test_that("Test case 45",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),(w1/3),(w2/6),(w3/8),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),(w1/8),(w2/1),(w3/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),(w1/7),(w2/5),(w3/7),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),rep(0,N),(w1/1),(w2/8),(w3/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
