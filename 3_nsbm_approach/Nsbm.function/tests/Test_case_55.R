...
Data_1 <- matrix(c(3,5,1,2,
                   7,1,5,8,
                   2,5,2,1,
                   4,8,2,5),byrow=TRUE, nrow=4);
...
test_that("Test case 55",{
  ...
  obj_func_i1 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/3)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/7)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/2)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(1,rep(0,N),rep(0,N),rep(0,sum_r),-(0.5/4)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 2:
  Const_2_i1 <- matrix(c(-3,3,7,2,4,rep(0,N),rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i2 <- matrix(c(-7,3,7,2,4,rep(0,N),rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i3 <- matrix(c(-2,3,7,2,4,rep(0,N),rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i4 <- matrix(c(-4,3,7,2,4,rep(0,N),rep(0,sum_r),1), byrow = TRUE, nrow = 1);
