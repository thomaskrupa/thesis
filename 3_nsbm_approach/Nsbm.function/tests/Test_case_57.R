...
test_that("Test case 57",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),(0.5/5),(0.5/1),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),(0.5/1),(0.5/5),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),(0.5/5),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),(0.5/8),(0.5/2),rep(0,sum_m)), byrow = TRUE, nrow = 1);
  ...
  #Constraint 2:
  Const_2_i1 <- matrix(c(3,7,2,4,rep(0,N),rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i2 <- matrix(c(3,7,2,4,rep(0,N),rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i3 <- matrix(c(3,7,2,4,rep(0,N),rep(0,sum_r),1), byrow = TRUE, nrow = 1);

  Const_2_i4 <- matrix(c(3,7,2,4,rep(0,N),rep(0,sum_r),1), byrow = TRUE, nrow = 1);
