...
test_that("Test case 38",{
  ...
  obj_func_i1 <- matrix(c(rep(0,N),rep(0,N),rep(0,sum_r),-(w1/3),-(w2/8)), byrow = TRUE, nrow = 1);
  obj_func_i2 <- matrix(c(rep(0,N),rep(0,N),rep(0,sum_r),-(w1/7),-(w2/4)), byrow = TRUE, nrow = 1);
  obj_func_i3 <- matrix(c(rep(0,N),rep(0,N),rep(0,sum_r),-(w1/2),-(w2/3)), byrow = TRUE, nrow = 1);
  obj_func_i4 <- matrix(c(rep(0,N),rep(0,N),rep(0,sum_r),-(w1/4),-(w2/1)), byrow = TRUE, nrow = 1);
