...
Data_1 <- matrix(c(1, 2, 2, 1,
                   2,  1, 2, 1,
                   2,  2, 2, 2),byrow=TRUE, nrow=3);
...
test_that("Test case 264",{


  # weightsNSBM
  weightsNSBM <- matrix(c(1,rep(2,(K*N)),2,3,4,5,6,
                          1,rep(2,(K*N)),3,4,5,6,7,
                          1,rep(2,(K*N)),4,5,6,7,8), byrow = TRUE, nrow = 3);

  # slack_plus
  slack_plus <- matrix(c(2,5,
                         3,6,
                         4,7), byrow = TRUE, nrow = 3);
  ...
  nsbm.div_res <- matrix(c(  -2/6, -3/2,
                             -1/7, -5/2.5,
                             -1.5/4.5, -2.5/3), byrow = TRUE, nrow = 3);
