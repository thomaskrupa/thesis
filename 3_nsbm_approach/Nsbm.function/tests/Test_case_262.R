...
test_that("Test case 262",{
  ...
  Const_5_i1 <- matrix(c(0,-10,-4,-8,10,4,8,rep(0,N),rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l)),
                         0,-5,-7,-4,5,7,4,rep(0,N),rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l)),
                         0,rep(0,N),-1,-5,-2,1,5,2,rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l)),
                         0,rep(0,N),-4,-3,-2,4,3,2,rep(0,sum_r),rep(0,sum_m),rep(0,(2*sum_l))), byrow = TRUE, nrow = 4);
